...
local theme = lush(function()
  return {
    ...
    StatusLineNC { fg=base4, bg=base0 }, -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
